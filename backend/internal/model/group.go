...
type GroupRequest struct {
	...
	HandleUserID  int64     `gorm:"column:handle_user_id"`
...
type Group struct {
	...
	CreatorUserID         int64     `gorm:"column:creator_user_id;comment:群创建者ID"`
	...
	NotificationUserID    int64     `gorm:"column:notification_user_id;comment:最后更新群公告的用户ID"`
}
...
type GroupMember struct {
	...
	InviterUserID  int64     `gorm:"column:inviter_user_id;comment:邀请人ID"`
	OperatorUserID int64     `gorm:"column:operator_user_id;comment:操作人ID"`
